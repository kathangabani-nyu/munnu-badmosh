...
export const conversationData: ConversationData = {
  ...
  nodes: {
    ...
    ultimatum: {
      ...
      choices: [
        { id: "c9a", text: "oh god what is it", nextNodeId: "the_reveal" },
        { id: "c9b", text: "if it's another rigged quiz i'm leaving", nextNodeId: "the_reveal" },
      ],
    },
    ...
    the_reveal: {
      ...
      messages: [
        {
          id: "tr1",
          sender: "them",
          text: "no no it's actually something nice for once",
          delay: 500,
          typingDuration: 1500,
        },
        {
          id: "tr2",
          sender: "them",
          text: "i put together all our photos and stuff",
          delay: 500,
          typingDuration: 1500,
        },
        {
          id: "tr3",
          sender: "them",
          text: "like a little memory thing",
          delay: 400,
          typingDuration: 1200,
        },
        {
      ...
      choices: [
        { id: "c10a", text: "kathan...", nextNodeId: "sweet_ending" },
        { id: "c10b", text: "that's actually really sweet??", nextNodeId: "sweet_ending" },
        { id: "c10c", text: "who are you and what have you done with kathan", nextNodeId: "sweet_ending" },
      ],
    },
      ...
      messages: [
        {
          id: "se1",
          sender: "them",
          text: "i said don't make it weird!!!!",
          delay: 400,
          typingDuration: 1200,
        },
        {
        ...
        },
        {
          id: "se4",
          sender: "them",
          text: "and yes i stayed up till 3am making this",
          delay: 800,
          typingDuration: 1500,
        },
        {
          id: "se5",
          sender: "them",
          text: "no i will not be accepting criticism at this time",
          delay: 400,
          typingDuration: 1800,
        },
      ],
